...
namespace TableDataProcessingTool.CSharpFiles
{
    ...
    public class SheetFileStructure : BaseClass
    {
        ...
        {
            if (System.IO.Path.GetExtension(FilenameInput).Equals(".sheets"))
            {
            ...
            if (File.Exists(this.Filename))                        //    File is existed
            {
                ...
                for (int LoopNumberForTableCount = 0; LoopNumberForTableCount < TabelReadFromFile.Tables.Count; LoopNumberForTableCount++)
                {
                    ...
                    {
                        TableDataProcessingTool.CSharpFiles.BlockStructure NewBlockStructure =
                        ...
                        try
                        {
                            ...
                            //System.Environment.CurrentDirectory + FilenameInput
                            FilenameInput
                            );
