...
using TableDataProcessingTool.CSharpFiles;
using TableDataProcessingTool.CSharpFiles.SettingsItems;
using TableDataProcessingTool.WinForms.SelectedCellsInfo;
...
namespace TableDataProcessingTool
{
    public partial class Main: Form
    {
        ...
        private TableDataProcessingTool.CSharpFiles.BlockStructure MainBlockStructure;
        ...
        public Main()
        {
            ...
            {
                const bool EnableReadingXLSFile = false;
                const bool EnableReadingXLSXFile = false;
                ...
                foreach (string fileName in SelectMultipleSheetsFile())
                {
                    if (
                        (
                            ...
                            System.IO.Path.GetExtension(fileName).Equals(".sheets")     //    Accept .sheets file format
                        ).Equals(false) ||
                        fileName.Contains("~$") ||
        ...
        private string[] SelectMultipleSheetsFile()
        {
            ...
            openFileDialog1.Filter = "sheets files (*.sheets)|*.sheets";
